...
if __name__ == "__main__":
    ...
    base_args.uavs_num = 5  # UAV 个数
    test_seed = 42

    checkpoint_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "checkpoint", "checkpoint_mhbppo_uav5")
    # checkpoint_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "checkpoint", "checkpoint_mhbppo_uav1")
    ...
    for test_seed in tqdm([test_seed], desc="Testing Seeds"):
        ...
        # reward_filename = f"{current_time_str}_MHBPPO_seed{test_seed}_rewards.csv"
        reward_filename = f"{current_time_str}_MHBPPO_seed{test_seed}_rewards_uav1.csv"
    ...
    # filename = f"{current_time_str}_MHBPPO_test_results_uav.csv"
    filename = f"{current_time_str}_MHBPPO_test_results_uav_5.csv"
