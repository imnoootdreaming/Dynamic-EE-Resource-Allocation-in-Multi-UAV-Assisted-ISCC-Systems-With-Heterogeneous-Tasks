...
if __name__ == "__main__":
    ...
    for test_seed in tqdm([test_seed], desc="Testing Seeds"):
        ...
        reward_filename = f"{current_time_str}_SHBPPO_seed{test_seed}_rewards_uav4.csv"
    ...
    filename = f"{current_time_str}_SHBPPO_test_results_uav_4.csv"
